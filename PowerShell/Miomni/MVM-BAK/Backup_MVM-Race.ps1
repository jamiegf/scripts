...
$destFolder = "E:\MVM-Race"
$sourceDrive = "\\10.10.10.224\c$"
$retentionDays = 4
...
$emailBody = @"
Backups for MVM-Race are now complete
Logs attached.
...
"@
                            ...
                            $port = "587"
			    $subject = "Backups MVM-Race"
                $attachments = "E:\MVM-Race\$today\_logs\Log_WWWRoot.txt", "E:\MVM-Race\$today\_logs\Log_Gaming.txt", "E:\MVM-Race\$today\_logs\Log_Miomni.txt", "E:\MVM-Race\$today\_logs\Log_Scripts.txt" 
