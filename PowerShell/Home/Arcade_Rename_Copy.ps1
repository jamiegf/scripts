...
#####copy rom
@(Get-ChildItem c:\users\j\Downloads\* -Include *.7z, *.zip | Sort LastWriteTime -Descending)[0] |  Copy-Item -destination $arcadeOutFolder -force 
#copy snap  video
...
& "C:\Program Files (x86)\WinSCP\WinSCP.com" `
  ...
  /command `
    ...
    "put $arcadeOutFolder\*.$extension /home/jamiegf/roms/$console/" `
