...
Set objTextFile = fso.OpenTextFile("c:\scripts\service_status.txt", 8, True)
                                ...
                                Set colServices = objWMIService.ExecQuery("Select * from Win32_Service where StartMode = 'Auto' and State = 'Stopped' and displayname <> 'Software Protection'")
                                ...
                                For Each objService in colServices
											x = x + 1
                                               ...
                                               objTextFile.WriteLine "SERVICE DOWN! : " & objService.Displayname & vbcrlf
