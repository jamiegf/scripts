...
Const ADS_UF_DONT_EXPIRE_PASSWD = &h10000
 strUser = InputBox ("enter name")
objUserLDAP = FindUser(strUser)

'Set objUserLDAP = GetObject _
  '("LDAP://cn=" & strUser & ",ou=Admin Accounts,OU=Bytes Technology Group Ltd,DC=Bytes,DC=co,DC=uk")
...
Else
    ...
    Set objDomainNT = GetObject("WinNT://bytesnet")
