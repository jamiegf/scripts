#When adding a new casino. check logs are going to \\bak\E$\Wager_logs 

#>
$yesterday = ((get-date).adddays(-1)).tostring('MM_dd_yyyy') 
$yesterdayUS = ((get-date).adddays(-1)).tostring('yyyy-MM-dd') 
$yesterday2 = ((get-date).adddays(-2)).tostring('MM_dd_yyyy') 
$Node1 = "\\sports1"
$Node2 = "\\sports2"
$Node3 = "\\sports3"
$NodeR = "\\race1"
...
$Lotterylogfolder = "$Node1\C$\inetpub\wwwroot\WVLotteryLogs\Logs\MapLogsDaily\$yesterday2"
...
"@
                            ...
                            $subject = "Wager Logs: West Virginia"
 ...
 Copy-Item "$Node1\C$\inetpub\wwwroot\Wager_logs_DN\Logs\MapLogsDaily\$yesterday2" $Lotterylogfolder -Recurse
