#backup MVM-Race (10.10.10.224) (folders and IIS sites & bindings)
#copies yesterdays to todays then compare and sync live server with backup
#

$destFolder = "E:\MVM-test"
$sourceDrive = "\\10.10.10.190\c$"
$retentionDays = 3
...
$emailBody = @"
Backups for MVM-test are now complete
Logs attached.
...
"@
                            ...
                            $port = "587"
			    $subject = "Backups MVM-Test"
                $attachments = "E:\MVM-test\$today\_logs\Log_WWWRoot.txt", "E:\MVM-test\$today\_logs\Log_Gaming.txt", "E:\MVM-test\$today\_logs\Log_Miomni.txt", "E:\MVM-test\$today\_logs\Log_Scripts.txt" 
