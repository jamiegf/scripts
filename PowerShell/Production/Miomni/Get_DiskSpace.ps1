...
$comps = "mvm-bak", "mvm-inplay1","mvm-inplay2",,"mvm-inplay3","mvm-inplay4""mvm-prd1","mvm-prd2","mvm-prd3","mvm-race1", "mvm-race2", "mvm-arr1", "mvm-arr2", "mvm-arr3","mvm-dc01", "mvm-dc02", "mvm-sql1", "mvm-sql2", "MVM-Test-SQL", "MVM-Web2", "MVM-Web"
$subject = "Disk Space"
$outputcombined = ""
$subjectWarning =  ""
$message = ""
